  ...
  return (
    <Flex width="100%" maxWidth="980px" flexDir="column">
      <Text color="var(--dark)" fontSize="20px" fontWeight="500" mb="20px">
        {t("pages.loads.clients.client-creator")}
      </Text>
      <label>{t("pages.loads.clients.name")}</label>
      <Input
        mb="20px"
        bg="white"
        onInput={handleChange}
        name="name"
        placeholder={t("pages.loads.clients.name")}
      />
      <label>{t("pages.loads.clients.short-name")}</label>
      <Input
        mb="20px"
        bg="white"
        onInput={handleChange}
        name="shortName"
        placeholder={t("pages.loads.clients.short-name")}
      />
      <label>E-mail</label>
      <Input
        type="email"
        ...
        placeholder="E-mail"
      />
      <label>{t("pages.loads.clients.phone-number")}</label>
      <Input
        type="number"
        bg="white"
        onInput={handleChange}
        name="phone"
        placeholder={t("pages.loads.clients.phone-number")}
      />
