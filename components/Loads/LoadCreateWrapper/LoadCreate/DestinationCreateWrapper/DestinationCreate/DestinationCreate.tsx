  ...
  return (
    <Flex width="100%" maxWidth="980px" flexDir="column">
      <Text color="var(--dark)" fontSize="20px" fontWeight="500" mb="20px">
        {t("pages.loads.destinations.destination-creator")}
      </Text>
      ...
      <label>{t("pages.loads.destinations.address")}</label>
      <Input
        mb="20px"
        bg="white"
        onInput={handleChange}
        name="address"
        placeholder={t("pages.loads.destinations.address")}
      />
      <label>{t("pages.loads.destinations.postal-code")}</label>
      <Input
        mb="20px"
        bg="white"
        onInput={handleChange}
        name="postalCode"
        placeholder={t("pages.loads.destinations.postal-code")}
      />
      <label>{t("pages.loads.destinations.city")}</label>
      <Input
        mb="20px"
        bg="white"
        onInput={handleChange}
        name="city"
        placeholder={t("pages.loads.destinations.city")}
      />
      <label>{t("pages.loads.destinations.country")}</label>
      <Input
        mb="20px"
        bg="white"
        onInput={handleChange}
        name="country"
        placeholder={t("pages.loads.destinations.country")}
      />
